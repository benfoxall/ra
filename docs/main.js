...
var mqt$1 = createCommonjsModule(function (module, exports) {
...
var mqt = new mqt$1('test.mosquitto.org:8080');

mqt.subscribe('/connections', function (m) { return console.log(("Connected: " + m)); }
);
